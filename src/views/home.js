    ...
    <div className="home-container">
      ...
      <section className="home-hero">
        ...
        <div className="home-main">
          ...
          <div className="home-image11">
            <img
              alt="image"
              src="/playground_assets/doctor-image-1500w.png"
      ...
      <section id="how-it-works" className="home-why">
        ...
        <div className="home-content03">
          <div className="home-video">
            <video
              src
              poster="/playground_assets/video-1500w.png"
      ...
      <section className="home-features1">
        <div className="home-section6">
          ...
          <img
            alt="image"
            src="/playground_assets/xray-1500w.png"
        ...
        <div className="home-section7">
          ...
          <img
            alt="image"
            src="/playground_assets/lab-1500w.png"
        ...
        <div className="home-section8">
          ...
          <img
            alt="image"
            src="/playground_assets/examination-1500w.png"
      ...
      <section className="home-meet">
        ...
        <div className="home-list1">
          ...
          <div data-teleport="doctors" className="home-doctors">
            <Doctor></Doctor>
            <Doctor image_src="/playground_assets/doctor-2-300w.png"></Doctor>
            <Doctor image_src="/playground_assets/doctor-3-300w.png"></Doctor>
            <Doctor image_src="/playground_assets/doctor-4-300w.png"></Doctor>
          </div>
        </div>
